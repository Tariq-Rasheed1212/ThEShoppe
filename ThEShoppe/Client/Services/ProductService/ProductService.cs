...
namespace ThEShoppe.Client.Services.ProductService
{
    public class ProductService : IProductService
    {
        ...
        new Product {
            ...
            CategoryId = 1,
            Title = "Scarface",
            Description = "1983 (Crime, Drama) In 1980 Miami, a determined Cuban immigrant takes over a drug cartel and succumbs to greed.",
        ...
        new Product {
            ...
            CategoryId = 5,
            Title = "Spectre",
            Description = "2015 (Action, Adventure) A cryptic message from James Bond's past sends him on a trail to uncover the existence of a sinister organisation named SPECTRE. With a new threat dawning, Bond learns the terrible truth about the author of all his pain in his most recent missions.",
